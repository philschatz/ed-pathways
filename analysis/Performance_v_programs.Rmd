...
# the expectations of the above models
...
# we'll just go through this one and update when new methods occur.
...
# We want size to scale with area, so that a school twice as big looks twice as big
p <- p + scale_size_area()
...
```{r echo=FALSE}
# To give a fuller picture of the distribution of the residual performance data,
# We use box-and-whisker plots.
